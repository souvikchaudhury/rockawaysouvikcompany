						...
						<div class="ticket-booking-form chk<?php echo $posts->ID.$count?>">
							...
							<div class="text<?php echo $posts->ID.$count?>">
								<div class="age-status">
									...
									<input type="text" name="adult" class="ad text adult_txt disT" id="adult_txt" value="0" placeholder="0"/>                                                                     
								...
								<div class="age-status">
									...
									<input type="text" name="senior" class="sn text senior_txt disT" id="senior_txt" value="0" placeholder="0"/>
								...
								<div class="age-status">
									...
									<input type="text" name="child" class="ch text child_txt disT" id="child_txt" value="0" placeholder="0"/>
...
function  replace_stuff($find, $replace, $subject)
{
	$i = 0;
	...
	if($seconds >= 0 && $hours > 24 && $seatavl == 'Yes') {
			...
			if(mysql_num_rows($mysqlRes) > 0) {
					...
					if($mysqlRes1){
						...
						$to = trim(get_option( 'ticketemailid',true));
						$to1 = trim($_POST['email']);
						$subject = 'Ticket Reservation Information';
						$subject1 = trim($_POST['eventtitle'].':Ticket Reservation');
...
// 						$headers1 .= "X-Mailer: php\n";
						$headers1[]= 'From: Rockaway Theatre Company <egap17@yahoo.com>';
						...
						$message1 = '<h2>Rockaway Theatre Company Confirmation Mail</h2>
						...
						//$result = wp_mail($to1, $subject1, $message1,$headers1);
						//$result = wp_mail($to1, $subject1, 'dsfsdfsd',$headers1);
						//var_dump($result);
