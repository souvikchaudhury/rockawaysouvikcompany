...
if(isset($_POST['submit']))
{
	...
	$admin_mail_tmpl = $_POST['admin_mail_tmpl'];
	if($admin_mail_tmpl!='')
		update_option( 'admin_mail_tmpl', $admin_mail_tmpl );

	$cust_mail_tmpl = $_POST['cust_mail_tmpl'];
	if($cust_mail_tmpl!='')
		update_option( 'cust_mail_tmpl', $cust_mail_tmpl );
}
?>
...
<br>
<h2> Admin Mail body Template </h2>
<?php the_editor(get_option('admin_mail_tmpl',true), 'admin_mail_tmpl', '', 'true', 2, 'more'); ?>
<br>
<h2> Customer Mail body Template </h2>
<?php the_editor(get_option('cust_mail_tmpl',true), 'cust_mail_tmpl', '', 'true', 2, 'more'); ?>
<br>
