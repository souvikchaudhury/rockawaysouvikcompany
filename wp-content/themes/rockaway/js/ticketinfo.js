...
function AllfuncCall(AjxUrl){
	...
	$('.submit').click(function(){
		...
		//var mobilenoformat = /^(\([0-9]{3}\)|[0-9]{3}-)|\s[0-9]{3}-[0-9]{4}$/;
		var mobilenoformat = /^(\([0-9]{3}\)|[0-9]{3})([\s]{1}|[\-]{1}|)([0-9]{3})([\s]{1}|[\-]{1}|)([0-9]{4})$/;
		//|| !$.isNumeric(mobile_number)
		if (mobile_number == '' || mobile_number == null || mobile_number =="Enter Your Phone No" || !mobilenoformat.test( mobile_number ) )
		{
