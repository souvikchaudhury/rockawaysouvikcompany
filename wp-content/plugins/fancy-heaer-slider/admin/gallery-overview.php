...
$title = __('Fancy Header Slider Overview');
?>
				...
				<div class="meta-box-sortables ui-sortable" id="left-sortables"  style="min-height:0px;">
					<div class="postbox" >	
						<div class="inside" style="margin:10px;">
							Please mark your valuable ratings at <a href="http://wordpress.org/extend/plugins/fancy-heaer-slider/" target="_blank" >
							<?php
							for ($i=0; $i < 5; $i++) { 
								?>
					...
					<div class="postbox" id="gallery_overview">	
						...
						<h3 id="hndle_overview" class="hndle"><span>Fancy Header Slider Overview</span></h3>
						<div class="inside" style="margin:10px;">
							<?php FancyHeaderSlider::fhs_overview(); ?>
						</div>
					</div>	
